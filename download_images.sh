...
UBOOT="u-boot-rockchip/RK3288UbootLoader_V2.19.01.bin"
...
CMDLINE:console=ttyFIQ0,115200 root=/dev/block/mtd/by-name/linuxroot rw rootfstype=ext4 init=/sbin/init initrd=0x62000000,0x00800000 "
